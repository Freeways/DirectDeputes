            ...
            <div class="column col-sm-9" id="main">
                <div class="padding">
                    <div class="full col-sm-9">
                        ...
                        $req="select * from sujets where id_sujet like '$id_sub'";
                          ...
                          {   
                              ...
                              <div class='row' style='height: 20%;''>    
                                <div class='col-sm-10'>
                                  ...
                                  <a href='suvotep.php?id=".$id_sub."'>
                                    ".$votep."  <span class='glyphicon glyphicon-thumbs-up' style='display:inline;'></span></a>
                                  
                                  <a href='suvotem.php?id=".$id_sub."'>
                                              ".$votem."  <span class='glyphicon glyphicon-thumbs-down' style='display:inline;float:right;'></span></a>
                                  </div>
                        ...
                        $req_com="select * from commentaires where subj like '$id_sub'";
                          $result_com=mysql_query($req_com);
                        ...
                        <div class='panel panel-default'>
                          <div class='panel-heading'> User ".$data_com['usr']."
                            <div class='col-sm-2' style='float:right;'>
                          ...
                          <div class='panel-body'> Commentaire : ".$data_com['contenue']."
                      ...
                      ?>
                        ...
                        <div class="form-group">
                          <input class="form-control input-lg" id="inputLarge" type="text" placeholder="Laissez un commentaire..">
                        </div>

                        <div class="form-group">
                          <div class="col-lg-10 col-lg-offset-2">
                            <button type="submit" class="btn btn-primary" style="float:right;">Commenter</button><br><br>
                          </div>
                        </div>
                        </div>
